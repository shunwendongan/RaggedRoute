...
See [Benchmark architecture](docs/benchmark-architecture.md), the [correctness framework](docs/correctness-framework.md), [CI quality gates](docs/ci-quality-gates.md), [implementation status](docs/implementation-status.md), the [repository audit](docs/reviews/repository-audit-2026-08-03.md), the [current RTX 3080 benchmark/Nsight report](docs/reports/rtx3080-naive-profile-a9489ab.md), and the [full technical design](docs/RaggedRoute-最终产品技术文档.md).
