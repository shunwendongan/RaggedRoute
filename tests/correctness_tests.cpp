  ...
  try {
    ...
    try {
      const std::vector<Case> cases = {
          ...
          {"histogram", {{"T", "33"}, {"E", "31"}, {"top_k", "1"}, {"distribution", "round_robin"}}},
          {"histogram", {{"T", "255"}, {"E", "32"}, {"top_k", "1"}, {"distribution", "uniform"}}},
          {"histogram", {{"T", "256"}, {"E", "33"}, {"top_k", "1"}, {"distribution", "zipf"}, {"zipf_s", "1.0"}}},
          {"histogram", {{"T", "257"}, {"E", "64"}, {"top_k", "1"}, {"distribution", "zipf"}, {"zipf_s", "2.0"}}},
          {"histogram", {{"T", "4096"}, {"E", "8"}, {"top_k", "1"}, {"distribution", "single_hot"}}},
